...
const projects = [
  ...
  {
    title: 'LEVELIZE',
    description: 'An Android application inspired by the anime Solo Leveling. Features a gamified tracking and leveling system developed natively in Kotlin.',
    image: 'https://images.unsplash.com/photo-1550745165-9bc0b252726f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxnYW1pbmclMjBtb2JpbGV8ZW58MXx8fHwxNzU2NDM4ODIw&ixlib=rb-4.1.0&q=80&w=1080',
    technologies: ['Kotlin', 'Android Studio', 'XML'],
    category: 'Mobile Development',
    featured: false,
    links: {
      demo: '#',
      github: 'https://github.com/subhasish12345/LEVELIZE-',
    },
    status: 'Completed',
  ...
  },
  {
    ...
    featured: false,
    links: {
      demo: 'https://mystudenthub.onrender.com/',
...
const categoryColors = {
  ...
  'Mobile Development': 'bg-teal-500/10 text-teal-600 border-teal-500/20',
};
