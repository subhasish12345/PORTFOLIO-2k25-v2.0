...
const timelineEvents = [
  {
    ...
    company: 'Qspiders',
    period: 'Dec 27, 2025 - Present',
    location: 'Onsite',
    type: 'Training',
    status: 'Ongoing',
    description: 'Specialized physical training program in Data Analysis and Python, focusing on hands-on implementations and practical scenarios.',
